...
/**
 * District_Model_Doctrine_BaseEvent
 * 
 ...
 */
abstract class District_Model_Doctrine_BaseEvent extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('district_event');
    ...
    {
        parent::setUp();
        $this->hasMany('District_Model_Doctrine_EventTranslation as Translation', array(
             'local' => 'id',
             'foreign' => 'id'));
