...
/**
 * District_Model_Doctrine_BaseAttraction
 * 
 ...
 */
abstract class District_Model_Doctrine_BaseAttraction extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('district_attraction');
    ...
    {
        parent::setUp();
        $this->hasMany('District_Model_Doctrine_AttractionTranslation as Translation', array(
             'local' => 'id',
             'foreign' => 'id'));
