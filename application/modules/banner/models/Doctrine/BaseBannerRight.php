...
/**
 * Banner_Model_Doctrine_BaseBannerRight
 * 
 ...
 * @property boolean $gif_iframe
 * @property clob $gif_iframe_content
 ...
 */
abstract class Banner_Model_Doctrine_BaseBannerRight extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('banner_banner_right');
        ...
        $this->hasColumn('gif_iframe', 'boolean', null, array(
             'type' => 'boolean',
             'default' => 0,
             ));
        $this->hasColumn('gif_iframe_content', 'clob', null, array(
             'type' => 'clob',
             ));
